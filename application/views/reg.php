...
<form id="frm_reg" action="user/add_user" method="POST" onsubmit="return false;" style="float:left; width:620px;">
...
<script src="assets/images/getcity.js"></script><span class="nodisp">请选择您所在的地区</span></td>
    	...
    	<tr>
			...
			<span><a href="javascript:_rvi()" id="change-code">换另外一个图</a></span>
			</td>
    	</tr>
		<tr>
    		<th>&nbsp;</th>		
    	...
    	<tr class="buttons">
    		...
    		<input value=" 注册新用户 " class="BUTTON SUBMIT" type="submit" name="reg" id="btn-reg">
			</td>
    	</tr>
	</tbody></table>
</form>
