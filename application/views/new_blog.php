...
<div id="AdminScreen">
	...
	<li class="caption">个人信息管理		
		<ol>
			<li><a href="welcome/inbox">站内留言(0/1)</a></li>
...
<ul>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="welcome/pulish_blog" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  ...
  <tr class="submit">
	<td>
	<input value=" 发 表 " class="BUTTON SUBMIT" type="submit" id="ipt-sendblog" onsubmit="return false">
