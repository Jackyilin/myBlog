...
<div class="MainForm BlogArticleManage">
  <h3 class="title">共有 <?php echo count($result) ?> 篇博客，每页显示 40 个，共 1 页</h3>
    <div id="BlogOpts">
  ...
  <ul>
		<?php foreach($result as $blogs) {?>
		<li class="row_1">
		<input name="blog" value="<?php echo $blogs->article_id ?>" type="checkbox">
		<a href="viewPost_comment.htm" target="_blank"><?php echo $blogs->title ?></a>
		<small><?php echo $blogs->post_date ?>2011-06-18 00:34</small>
		</li>
		<?php } ?>
		<!-- <li class="row_0">
