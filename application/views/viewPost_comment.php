...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <title><?php echo $article->title ?> -  <?php echo $user->username."的博客" ?> - SYSIT个人博客</title>
  ...
  <div class="BlogContent TextContent"><?php echo $article->content ?></div>
	...
	<ul>
          ...
          <li>上篇 <span>(1小时前)</span>：<a href="welcome/blog_detail?id=<?php echo $prev->article_id?>" class="prev"><?php echo $prev->title ?></a></li> 
				<?php } ?> 
				<?php if(isset($next)){ ?>
          <li>上篇 <span>(1小时前)</span>：<a href="welcome/blog_detail?id=<?php echo $next->article_id?>" class="prev"><?php echo $next->title ?></a></li> 
				<?php } ?> 
</ul>
  </div>
...
<!-- <div id="BlogComments">	 -->
  ...
  <div class="CommentForm">
    <a name="postform"></a>
    <form id="form_comment" action="/action/blog/add_comment?blog=24026" method="POST" onsubmit="return false">  
	  ...
	  <input value="发表评论" id="btn-comment" class="SUBMIT" type="submit"> 
...
<div class="CommentForm">
	<form id="form_inline_comment" action="/action/blog/add_comment?blog=24026" method="POST">
      ...
      <textarea id="btn-content" name="content" style="width: 450px; height: 60px;"></textarea><br>
