...
<form id="CatalogForm" action="welcome/add_blog_catalog" method="post" onsubmit="return false;">
    <h3> 添加博客分类 </h3>
    ...
    <span class="submit">
          <input value="添加&nbsp;»" tabindex="3" class="BUTTON SUBMIT" type="submit" id="add-btn">
		  <input value="修改&nbsp;»" tabindex="3" class="BUTTON SUBMIT" style="display: none" type="submit" id="edit-btn">
    </span>
</form>
...
<table cellpadding="1" cellspacing="1">
	...
	<?php foreach($types as $aa=>$type) {?>
	<tr id="catalog_92334">
		<td class="idx"><?php echo $aa+1 ?></td>
		...
		<td class="opts">
			<a href="javascript:;" title="点击修改博客分类" class="update-btn">修改</a>
